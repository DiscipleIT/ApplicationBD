...
namespace WindowsForms
{
    public partial class Form1 : Form
    {
        ...
        {
            sqlConnection = new SqlConnection(@" Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=E:\Project\VisualStudio\WindowsForms\WindowsForms\Database.mdf;Integrated Security=True");
            ...
            try
            {
                if(e.ColumnIndex == 6)
                {
                    ...
                    else if (task == "Insert")
                    {
                        ...
                        row["E-mail"] = dataGridView1.Rows[rowIndex].Cells["E-mail"].Value;
                    ...
                    else if (task == "Update")
                    {
                        ...
                        dataSet.Tables["Users"].Rows[r]["E-mail"] = dataGridView1.Rows[r].Cells["E-mail"].Value;
        ...
        private void dataGridView1_EditingControlShowing(object sender, DataGridViewEditingControlShowingEventArgs e)
        {
            ...
            //вместо 3 индекс ячейки, которую валидируем
